...
class DirectoryEntry {
  public:
    ...
    bool isDir;       // Is it a directory (1) or a file (0) ?
...
class Directory {
  public:
    ...
    bool AddDirectory(const char *name, int newSector);  // Add a directory name into the directory
  ...
  private:
    ...
    bool _Add(const char *name, int newSector, bool isDir); // Add a file or directory name into the directory
};
